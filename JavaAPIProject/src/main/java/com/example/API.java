// 04b5c7b8078642e8bf2db42f958fdd0c <- API key
package com.example;
...
public class API {
    public static String getHeadlines(String country, String key) throws Exception {
        ...
        // sports
        // technology
       String endpoint = "https://newsapi.org/v2/everything?q=" + country + "&apiKey=" + key;
